...
class Equipment:
    ...
    def __init__(self, eqtype, efficiency, price, mttf, mttr, start_date, end_date):
        ...
        @mttf - mean time between failures -- v fails in random time distributed as exp(1/mttf)
...
class EquipmentWindTurbine(Equipment):
    ...
    def __init__(self, efficiency, price, mttf, mttr, start_date, end_date, power, nominal_power, degradation_yearly):
        ...
        Equipment.__init__(self, EQ.WIND_TURBINE, efficiency, price, mttf, mttr, start_date, end_date)
        self.power = power
...
class PlantEquipment():
    ...
    def addWindTurbine(self, efficiency, price, mttf, mttr, power, nominal_power, degradation_yearly):
        wt = EquipmentWindTurbine(efficiency, price, mttf, mttr, self.start_date, self.end_date, power, nominal_power, degradation_yearly)
